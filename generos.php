...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        <a type="button" class="btn btn-dark btn-lg mb-2" href="addprenda.php"><i class="far fa-plus-square"> Registrar genero</i></a>
  ...
  <script src="dist/js/pages/generosedit.js"></script>
